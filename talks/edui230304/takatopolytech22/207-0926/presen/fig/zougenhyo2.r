...
Ketinit()
cat(ThisVersion,'\n')
Fnametex='zougenhyo2.tex'
FnameR='zougenhyo2.r'
Fnameout='zougenhyo2.txt'
...
Openfile('/Users/takatoosetsuo/polytech22.git/205-0926/presen/fig/zougenhyo2.tex','6mm','Cdy=graph22207.cdy')
Drwline(tb1c0r0r3)
Drwline(tb1c1r0r3)
Drwline(tb1c2r0r3)
Drwline(tb1c3r0r3)
