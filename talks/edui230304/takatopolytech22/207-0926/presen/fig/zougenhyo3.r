...
Ketinit()
cat(ThisVersion,'\n')
Fnametex='zougenhyo3.tex'
FnameR='zougenhyo3.r'
Fnameout='zougenhyo3.txt'
...
Openfile('/Users/takatoosetsuo/polytech22.git/205-0926/presen/fig/zougenhyo3.tex','6mm','Cdy=graph22207.cdy')
Drwline(tb1c0r0r3)
Drwline(tb1c1r0r3)
Drwline(tb1c2r0r3)
Drwline(tb1c3r0r3)
