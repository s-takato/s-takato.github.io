...
Ketinit()
cat(ThisVersion,'\n')
Fnametex='zougenhyo6.tex'
FnameR='zougenhyo6.r'
Fnameout='zougenhyo6.txt'
...
Openfile('/Users/takatoosetsuo/polytech22.git/205-0926/presen/fig/zougenhyo6.tex','6mm','Cdy=graph22207.cdy')
Drwline(tb1c0r0r3)
Drwline(tb1c1r0r3)
Drwline(tb1c2r0r3)
Drwline(tb1c3r0r3)
...
Letter(c(4.4,0.9),"c","$+$")
Letter(c(0.4,0.3),"c","$$")
Letter(c(1.2,0.3),"c","$\\NEarrow$")
Letter(c(2,0.3),"c","$$")
Letter(c(2.8,0.3),"c","$\\SEarrow$")
Letter(c(3.6,0.3),"c","$$")
Letter(c(4.4,0.3),"c","$\\NEarrow$")
Closefile("0")
