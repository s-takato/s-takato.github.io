...
Ketinit()
cat(ThisVersion,'\n')
Fnametex='2kyokusen3.tex'
FnameR='2kyokusen3.r'
Fnameout='2kyokusen3.txt'
...
sgha1=Listplot(c(c(0.5,1),c(0.5,-4.35893),c(2.95909,-4.35893),c(2.95909,1.61288)))
join1ha1=Joincrvs(bzo2,sgha1)
sgha1=Listplot(c(c(0,0),c(0,7.21786),c(3.47858,7.21786),c(3.47858,0)))
...
Openfile('/Users/takatoosetsuo/polytech22.git/205-0926/presen/fig/2kyokusen3.tex','6mm','Cdy=graph22207.cdy')
Drwline(bzo1,1.5)
Drwline(bzo2,1.5)
Drwline(sg1)
Drwline(sg2)
