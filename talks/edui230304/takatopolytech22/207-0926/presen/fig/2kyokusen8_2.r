...
Ketinit()
cat(ThisVersion,'\n')
Fnametex='2kyokusen8_2.tex'
FnameR='2kyokusen8_2.r'
Fnameout='2kyokusen8_2.txt'
...
sgha1=Listplot(c(c(0.5,2),c(0.5,-6.35893),c(3,-6.35893),c(3,3)))
join1ha1=Joincrvs(bzo1,sgha1)
sgha1=Listplot(c(c(0,0),c(0,8.21786),c(3.47858,8.21786),c(3.47858,0)))
...
Openfile('/Users/takatoosetsuo/polytech22.git/205-0926/presen/fig/2kyokusen8_2.tex','6mm','Cdy=graph22207.cdy')
Drwline(bzo1,1.5)
Drwline(bzo2,1.5)
Drwline(sg1)
Drwline(sg2)
