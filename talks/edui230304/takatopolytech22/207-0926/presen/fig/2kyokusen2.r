...
Ketinit()
cat(ThisVersion,'\n')
Fnametex='2kyokusen2.tex'
FnameR='2kyokusen2.r'
Fnameout='2kyokusen2.txt'
...
Openfile('/Users/takatoosetsuo/polytech22.git/205-0926/presen/fig/2kyokusen2.tex','6mm','Cdy=graph22207.cdy')
Drwline(bzo1,1.5)
Drwline(bzo2,1.5)
Drwline(sg1)
Drwline(sg2)
