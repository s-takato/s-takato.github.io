...
Ketinit()
cat(ThisVersion,'\n')
Fnametex='sekibun2.tex'
FnameR='sekibun2.r'
Fnameout='sekibun2.txt'
...
sgha1=Listplot(c(c(0,0),c(0,-15.62855),c(3,-15.62855),c(3,0)))
join1ha1=Joincrvs(sgx,sgha1)
sgha1=Listplot(c(c(3,0),c(-1.01412,0),c(-1.01412,-5),c(3,-5)))
join2ha1=Joincrvs(sg3,sgha1)
sgha1=Listplot(c(c(-1.01412,2.97157),c(4.07351,2.97157),c(4.07351,-12.5935),c(4.07351,-12.5935)))
...
Openfile('/Users/takatoosetsuo/polytech22.git/205-0926/presen/fig/sekibun2.tex','6mm','Cdy=graph22207.cdy')
Drwline(gr1,1.5)
Drwline(sg1,1.5)
Drwline(sg3,1.5)
Drwline(sght1)
