...
Ketinit()
cat(ThisVersion,'\n')
Fnametex='zougenhyo1.tex'
FnameR='zougenhyo1.r'
Fnameout='zougenhyo1.txt'
...
Openfile('/Users/takatoosetsuo/polytech22.git/205-0926/presen/fig/zougenhyo1.tex','6mm','Cdy=graph22207.cdy')
Drwline(tb1c0r0r3)
Drwline(tb1c1r0r3)
Drwline(tb1c2r0r3)
Drwline(tb1c3r0r3)
