...
Ketinit()
cat(ThisVersion,'\n')
Fnametex='kyokuchi2.tex'
FnameR='kyokuchi2.r'
Fnameout='kyokuchi2.txt'
...
gr2=Plotdata('(6*x^5-45*x^4+80*x^3+90*x^2-270*x)/30/3','x=c(2,XMAX)')
ln3=Lineplot(c(c(3,0),c(3,1)))
pt3=Pointdata(list(c(3,-0.300005)))
cr1pt3=Circledata(c(c(3,-0.3000045043),0.057))
sc1pt3=Scaledata(list(cr1pt3),1,1,c(3,-0.3000045043))
...
Openfile('/Users/takatoosetsuo/polytech22.git/205-0926/presen/fig/kyokuchi2.tex','6mm','Cdy=graph22207.cdy')
Drwline(gr1,1.5)
Texcom("{")
Setcolor(c(0,1,1,0))
Shade(list(sc1pt1))
