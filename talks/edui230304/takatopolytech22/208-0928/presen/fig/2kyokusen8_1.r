...
Ketinit()
cat(ThisVersion,'\n')
Fnametex='2kyokusen8_1.tex'
FnameR='2kyokusen8_1.r'
Fnameout='2kyokusen8_1.txt'
...
Openfile('/Users/takatoosetsuo/polytech22.git/205-0926/presen/fig/2kyokusen8_1.tex','6mm','Cdy=graph22207.cdy')
Drwline(bzo1,1.5)
Drwline(bzo2,1.5)
Drwline(sg1)
Drwline(sg2)
