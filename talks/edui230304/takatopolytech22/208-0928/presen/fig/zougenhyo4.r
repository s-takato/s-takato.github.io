...
Ketinit()
cat(ThisVersion,'\n')
Fnametex='zougenhyo4.tex'
FnameR='zougenhyo4.r'
Fnameout='zougenhyo4.txt'
...
Openfile('/Users/takatoosetsuo/polytech22.git/205-0926/presen/fig/zougenhyo4.tex','6mm','Cdy=graph22207.cdy')
Drwline(tb1c0r0r3)
Drwline(tb1c1r0r3)
Drwline(tb1c2r0r3)
Drwline(tb1c3r0r3)
