...
Ketinit()
cat(ThisVersion,'\n')
Fnametex='zougen2.tex'
FnameR='zougen2.r'
Fnameout='zougen2.txt'
...
Openfile('/Users/takatoosetsuo/polytech22.git/205-0926/presen/fig/zougen2.tex','6mm','Cdy=graph22207.cdy')
Drwline(bzo1,2)
Shade(list(sc1pt1))
Drwline(sc1pt1)
Shade(list(sc2pt1))
...
Shade(list(sc8pt1))
Drwline(sc8pt1)
Letter(c(-3.75,-1.8),"s","1")
Letter(c(-1.54,-2.52),"s","2")
Letter(c(0.41,-1.08),"se","3")
Letter(c(1.64,0.54),"n","4")
Letter(c(2.8,-1.08),"ne","5")
Letter(c(4.14,-1.05),"nw","6")
Drwline(axx1)
Drwline(axy1)
Letter(c(5.12,0),"e","$x$")
Letter(c(0,3.26),"n","$y$")
