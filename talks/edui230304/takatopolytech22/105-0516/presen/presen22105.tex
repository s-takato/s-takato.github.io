...
{\color{red}半径$1$}の円に点$\mathrm{P}(X,Y)$をとる
\item
[]\hspace*{3zw}$\cos x=\bunsuu{X}{r}\phantom{=X}$
\end{itemize}
...
\begin{layer}{120}{0}
\putnotes{60}{5}{\scalebox{0.9}{\input{fig/graphsin.tex}}}
\putnotew{55}{5}{\color{red}$\sin(-x)=-\sin x$}
\putnotee{65}{5}{（奇関数）}
\putnotes{60}{45}{\scalebox{0.9}{\input{fig/graphcos.tex}}}
...
\begin{layer}{120}{0}
\putnotes{60}{5}{\scalebox{0.9}{\input{fig/graphsinpi.tex}}}
\putnotes{60}{45}{\scalebox{0.9}{\input{fig/graphcospi.tex}}}
\end{layer}
...
\begin{itemize}
\item
[課題]\monban 次の単振動の和(差)を１つの単振動で表せ．\seteda{80}\\
...
\begin{itemize}
\item
[課題]\monban アプリで次の関数のグラフをかけ．また，特徴をあげよ．\seteda{57}\\
