...
\hspace*{1zw}$a^0=\phn{1},\ a^{-n}=\phn{\bunsuu{1}{a^n}},\ a^{\frac{n}{m}}=\phn{\sqrt[m]{a^n}}$
\end{itemize}
%%%%%%%%%%%%
...
\item
任意の実数$x$について$a^x$が定まる.\\
\hspace*{1zw}$a^0=1,\ a^{-n}=\phn{\bunsuu{1}{a^n}},\ a^{\frac{n}{m}}=\phn{\sqrt[m]{a^n}}$
\end{itemize}
...
\item
任意の実数$x$について$a^x$が定まる.\\
\hspace*{1zw}$a^0=1,\ a^{-n}=\bunsuu{1}{a^n},\ a^{\frac{n}{m}}=\phn{\sqrt[m]{a^n}}$
\end{itemize}
...
\putnotew{108}{73}{\hyperlink{para0pg6}{\fbox{\Ctab{4.5mm}{\scalebox{1}{\scriptsize $\mathstrut\!\!\lhd\!\!$}}}}}
...
\href{https://s-takato.github.io/polytech22/}{指数と対数}」を動かしてみよう
\item
$y=\log_a x$と$y=a^x$のグラフは\\　直線$y=x$に関して（\phn{{\color{red}対称}}）
\end{itemize}
...
[例)]$\log_3 8$を底が$2$の対数に変える\vspace{-2mm}
\item
[]　$\log_3 8=\bunsuu{\log_2\hakom{8}}{\log_2\hakom{3}}$\vspace{-2mm}
\end{itemize}
...
\item
ここでは規則的に並んだ数列とする\\
　$1,\ 3,\ 5,\ 7,\ \hakom{9},\ \hakom{11},\ \cdots$
\end{itemize}
...
\item
ここでは規則的に並んだ数列とする\\
　$1,\ 3,\ 5,\ 7,\ \hakoma{9},\ \hakom{11},\ \cdots$
\end{itemize}
...
$-1,\ 1,\ -1,\ 1,\ \cdots$\ の一般項は\ \hakoma{(-1)^n}
\item
$1,\ -1,\ 1,\ -1,\ \cdots$\ の一般項は\ \hakom{(-1)^{n-1}}
\end{itemize}
...
$1,\ -1,\ 1,\ -1,\ \cdots$\ の一般項は\ \hakoma{(-1)^{n-1}}
\item
$1,\ -2,\ 3,\ -4,\ \cdots$\ の一般項は\ \hakom{(-1)^{n-1}n}
\end{itemize}
...
$1,\ -2,\ 3,\ -4,\ \cdots$\ の一般項は\ \hakoma{(-1)^{n-1}n}
\item
$2,\ 0,\ 2,\ 0,\ \cdots$\ の一般項は\ \hakom{(-1)^{n-1}+1}
\end{itemize}
...
\putnotew{108}{73}{\hyperlink{para11pg7}{\fbox{\Ctab{4.5mm}{\scalebox{1}{\scriptsize $\mathstrut\!\!\lhd\!\!$}}}}}
...
\item
初項を$a$，公比を$r$とおくと\\
　$a,\ ar,\ ar^2,\ \cdots,\ \mbox{第$n$項}a_n=\hakom{a\,r^{n-1}}$
\end{itemize}
