%%% /Users/takatoosetsuo/Dropbox/2018polytec/lecture/0910/presen/fig/bibun4.tex 
...
\special{fp}%
\settowidth{\Width}{$f(x,y)$}\setlength{\Width}{-1\Width}%
\settoheight{\Height}{$f(x,y)$}\settodepth{\Depth}{$f(x,y)$}\setlength{\Height}{-0.5\Height}\setlength{\Depth}{0.5\Depth}\addtolength{\Height}{\Depth}%
\put(-0.1333333,1.0000000){\hspace*{\Width}\raisebox{\Height}{$f(x,y)$}}%
%
\special{pa    20  -591}\special{pa   -20  -591}%
\special{fp}%
\settowidth{\Width}{$f(x',y)$}\setlength{\Width}{-1\Width}%
\settoheight{\Height}{$f(x',y)$}\settodepth{\Depth}{$f(x',y)$}\setlength{\Height}{-0.5\Height}\setlength{\Depth}{0.5\Depth}\addtolength{\Height}{\Depth}%
\put(-0.1333333,2.0000000){\hspace*{\Width}\raisebox{\Height}{$f(x',y)$}}%
%
...
\special{fp}%
\settowidth{\Width}{$x'$}\setlength{\Width}{-0.5\Width}%
\settoheight{\Height}{$\xi$}\settodepth{\Depth}{$x'$}\setlength{\Height}{-\Height}%
\put(3.0000000,-0.1333333){\hspace*{\Width}\raisebox{\Height}{$x'$}}%
%
...
\special{fp}%
\settowidth{\Width}{$\varDelta z_1$}\setlength{\Width}{-0.5\Width}%
\settoheight{\Height}{$\varDelta z_1$}\settodepth{\Depth}{$\varDelta z_1$}\setlength{\Height}{-0.5\Height}\setlength{\Depth}{0.5\Depth}\addtolength{\Height}{\Depth}%
\put(0.5000000,1.5000000){\hspace*{\Width}\raisebox{\Height}{$\varDelta z_1$}}%
%
...
\special{fp}%
\settowidth{\Width}{${\color{red}dz_1}$}\setlength{\Width}{-0.5\Width}%
\settoheight{\Height}{${\color{red}dz_1}$}\settodepth{\Depth}{${\color{red}dz_1}$}\setlength{\Height}{-0.5\Height}\setlength{\Depth}{0.5\Depth}\addtolength{\Height}{\Depth}%
\put(3.5400000,1.3500000){\hspace*{\Width}\raisebox{\Height}{${\color{red}dz_1}$}}%
%
...
\put(0.0000000,4.0666667){\hspace*{\Width}\raisebox{\Height}{$z$}}%
%
