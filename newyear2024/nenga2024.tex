...
%\begin{layer}{80}{0}
%\putnotese{64}{6}{\scalebox{0.85}{\qrcode{https://s-takato.github.io/offline/ketmath2002vjsoffL.html}}}
%\end{layer}
...
%%\hfill {\tt\small takato@asahi.email.ne.jp}
%\end{minipage}}
...
\putnotese{68}{5}{%
\begin{minipage}{55mm}
　２５年ほど前に数式処理システムMapleで和算解法パッケージを作っていました．最近，久しぶりに動かしたところ，ちゃんと動いたので少し嬉しくなりました．現在，これをフリーのMaximaに移植して
...
\putnotese{0}{63}{\scalebox{0.85}{\qrcode{https://s-takato.github.io/offline/ketmath2002vjsoffL.html}}}
